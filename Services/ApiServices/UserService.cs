...
namespace DentalApp.Services.ApiServices
{
    public class UserService : ApiService
    {
        ...
        //public Task<List<Role>> GetRolesAsync() => GetAsync<List<Role>>("Role/GetAll") ?? Task.FromResult(new List<Role>());
        //public Task<List<UserVM>> GetUsersAsync() => GetAsync<List<UserVM>>("User/GetAll") ?? Task.FromResult(new List<UserVM>());
