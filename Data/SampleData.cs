...
namespace DentalApp.Data
{
    public static class SampleData
    {
        public static List<User> GetSampleUsers()
        {
            ...
            {
                new User { Id = 1, FirstName = "John", MiddleName = "D", LastName = "Doe", Email = "john@example.com", Mobile = "123-456-7890", RoleName = "Dentist" },
        ...
        public static List<Product> GetSampleProducts()
        {
            ...
            {
                new Product { Id = 1, Name = "Mouthwash", Description = "Alcohol-free mouthwash", Amount = 150, ProductType = 1 },
